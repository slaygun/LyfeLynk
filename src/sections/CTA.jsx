  ...
  return (
    <AnimatedSection>
      <section className="container py-10">
        <div className="shadow-[7px_7px_153px_10px_rgba(45,_72,_210,_0.52)] bg-gradient-to-r from-violet-400 via-blue-500 to-indigo-600 https://github.com/microsoft/table-transformer
