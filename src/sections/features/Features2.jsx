  ...
  const tabs = [
    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-lg p-10 bg-primary">
          ...
          <p className="text-sm md:text-2xl mb-4">LShare your anonymized health data and accelerate discoveries that have the potential to transform the medical world.. Your contributions could make a real difference in the lives of many.
          </p>
          <img
